...
export default function App() {
  ...
  const renderView = () => {
    ...
    if (currentView === 'practice' || currentView === 'available') return <AvailableChallenges onSelectProblem={handleSelectProblem} />;
    if (currentView === 'daily') return <DailyChallenge onSelectProblem={handleSelectProblem} />;
    if (currentView === 'submissions') return <SubmissionHistory onSelectProblem={handleSelectProblem} />;
    if (currentView === 'analytics') return <StudentAnalytics onSelectProblem={handleSelectProblem} />;
