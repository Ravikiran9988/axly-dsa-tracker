...
import { Terminal, ArrowRight, Sparkles, AlertCircle, Target, Trophy, Flame } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-[#080C14]">
      ...
      <div className="w-full max-w-lg space-y-8 relative z-10 py-10">
        <div className="text-center space-y-3">
          ...
          <span className="inline-block text-xs font-mono font-medium text-axly-400 bg-axly-500/10 px-3 py-1 rounded-full border border-axly-500/20">dsatracker.axly.in</span>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2 text-center">
          ...
          <div className="p-2.5 rounded-xl bg-slate-900/60 border border-slate-800/80 backdrop-blur"><Target className="w-4 h-4 text-axly-400 mx-auto mb-1" /><p className="text-[11px] font-medium text-slate-300">Curriculum Path</p></div>
        ...
        <div className="glass-panel p-7 sm:p-8 rounded-3xl border border-slate-800/80 shadow-2xl space-y-6">
          ...
          <div>
            ...
            <p className="text-[11px] text-center text-slate-500 mt-2.5 font-mono">Secure Google OAuth via Supabase</p>
          </div>
        </div>
      </div>
    </div>
